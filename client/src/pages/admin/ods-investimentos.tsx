              ...
              <CardContent>
                <div className="mb-6">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <p className="font-bold text-xl text-primary">{formatCurrency(calculateTotalInvestment())}</p>
                  </div>
                        ...
                        {stats.investmentsBySDG
                          ...
                          .map((item: any) => (
                            <TableRow key={item.sdg_number}>
                              ...
                              <TableCell>{item.total_amount ? formatCurrency(item.total_amount) : "0 Kz"}</TableCell>
