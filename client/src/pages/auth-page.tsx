          ...
          <div className="hidden md:flex flex-col items-center justify-center">
            <div className="bg-white p-8 rounded-lg shadow-lg">
              <div className="w-full max-w-md rounded-lg overflow-hidden bg-white">
                {/* Ilustração para a página de autenticação */}
                <div className="w-full h-56 bg-green-50 rounded-lg p-4 relative">
                  {/* Sol */}
                  <div className="absolute top-4 right-8 w-16 h-16 rounded-full bg-yellow-300"></div>
                  
                  {/* Árvores */}
                  <div className="absolute top-16 left-12">
                    <div className="w-16 h-16 rounded-full bg-green-800"></div>
                    <div className="w-3 h-12 bg-amber-800 mx-auto -mt-2"></div>
                  </div>
                  
                  <div className="absolute top-20 right-20">
                    <div className="w-16 h-16 rounded-full bg-green-600"></div>
                    <div className="w-3 h-10 bg-amber-800 mx-auto -mt-2"></div>
                  </div>
                  
                  {/* Montanha */}
                  <div className="absolute bottom-0 left-0 w-full h-24 bg-green-700 rounded-lg"></div>
                  <div className="absolute bottom-6 left-0 w-full h-24 bg-green-600"
                       style={{clipPath: "polygon(0% 100%, 20% 60%, 40% 80%, 60% 40%, 80% 70%, 100% 30%, 100% 100%)"}}></div>
                  
                  {/* Título */}
                  <div className="absolute top-28 left-1/2 transform -translate-x-1/2 text-center bg-white/80 backdrop-blur-sm p-3 rounded-lg shadow-md">
                    <div className="font-bold text-2xl bg-gradient-to-r from-green-600 to-teal-500 bg-clip-text text-transparent">Fundo Verde</div>
                    <div className="text-sm text-green-700">Sustentabilidade e Investimento</div>
                  </div>
                </div>
              </div>
              <div className="mt-6 text-center">
